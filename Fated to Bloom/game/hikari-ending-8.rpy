label hikariEnding8:
    ...
    me"\"What the…\""
    scene blood hand with fade
    me"\"R...yu...?\""
    me"\"No... it can't be...\""
    scene ryu dead
    "I start to shake his body, hoping he'd wake up. His head just moved lifelessly."
    me"\"AAAAAARRRRGGGGHHH!!! RYU!!\""
    "I continue trying, only to be caught in a headlock and have a wet cloth stuck into my face."
    me" (SHI-)"
    scene black with fade
    scene ryu dead with fade
    scene black with fade
    stop sound
    ...
    scene ryu dead
    "I turn to look where she is pointing, only to be greeted with the bloodied body of Ryu."
    me" \"You...RYu…\""
    "I struggled against the urge to vomit."
    "I could barely make out any words."
    me"\"You… Ryu...\""
    scene hikari desk knife evil
    play sound "<from 10.0>Evil Laughing Woman Sound.ogg"
